  ...
  return (
    <div className="flex">
      <div className="w-1/2 flex justify-end bg-page pt-56">
        ...
        <div className="relative w-96 border border-primary border-2px rounded-[10px] mt-14">
        <input className="w-full p-[26px] rounded-[10px] text-primary text-xl font-nuni font-semibold outline-none" type="email" />
        <h3 className="absolute top-[-13px] left-[50px] bg-page h-[13px] px-8 text-[#11175D] text-sm font-nuni font-semibold">Full Name</h3>
        </div>
       ...
       <p className="mt-8 ml-20 text-sm font-nuni font-regular text-white">Already  have an account ?<span className="font-bold text-primary"><Link to="/login">Sign In</Link></span> </p>
        </div>
      </div>
      <div className="w-1/2">
        <image>
